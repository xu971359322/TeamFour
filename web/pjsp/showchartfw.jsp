                    ...
                    <div class="col-md-6" style="width:1500px;">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <form action="${pageContext.request.contextPath}/p/ping_searchFW" method="post">
                                    <span>年份</span>
                                    <select name="yearName">
                                        <option value="-1" >全部</option>
                                        <c:forEach items="${sessionScope.year}" var="y">
                                            <option value="${y.year}" <c:if test="${y.year==requestScope.yearName}">selected</c:if> >${y.year}年</option>
                                        </c:forEach>
                                    </select>
