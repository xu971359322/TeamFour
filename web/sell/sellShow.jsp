    ...
    <div class="container-fluid" style="width: 100%">
        ...
        <div class="panel" style="width: 99%">
            ...
            <div class="panel-heading" style="float: right;">
                ...
                <a href="${pagecontext.request.getcontextpath}/sell/sellAdd.jsp"><div class="sell-div" style="font-size: 20px;height: 30px">新建</div></a>
            </div>
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="center">
                            <c:if test="${sessionScope.sellIndex != 1}">
                                <a href="sell_change?index=1"><div class="sell-div">首页</div></a>
                                <a href="sell_change?index=${sessionScope.sellIndex-1}"><div class="sell-div">上一页</div></a>
                            </c:if>
                            <c:if test="${sessionScope.sellIndex == 1 }">
                            ...
                            <c:if test="${sessionScope.sellIndex != sessionScope.sellcount}">
                                <a href="sell_change?index=${sessionScope.sellIndex+1}"><div class="sell-div">下一页</div></a>
                                <a href="sell_change?index=${sessionScope.sellcount}"><div class="sell-div">尾页</div></a>
                            </c:if>
                        </td>
                        <td></td>
