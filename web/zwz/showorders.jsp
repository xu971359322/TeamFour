...
<div style="margin-left:200px;">
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            ...
            <span class="r">共有数据：<strong>${orderslistcount }</strong> 条</span>
        </div>
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <c:forEach items="${orderslist}" var="z" varStatus="i" >
                    <tr class="text-c va-m">
                        ...
                        <td class="td-manage">
                            ...
                            <a style="text-decoration:none" class="ml-5" onClick="product_edit('${z.id}')"   title="查看明细">
...
<script type="text/javascript">
    ...
    function product_edit(id){
        $.ajax({
            type: 'POST',
            url:'${pageContext.request.contextPath }/z/zwz_showdetail?id='+id,
            dataType: 'json'

        });
        setTimeout(function(){
            self.location='${pageContext.request.contextPath }/zwz/showdetail.jsp';
        },150);
