...
<table class="table table-striped" align="center">
    ...
    <tr   style="background: #F9F9F9"    >
        <td align="center" >
            ...
            <button style="height: 30px;width: 50px"  onclick="window.location.href='${pageContext.request.contextPath }/zwz/addlinkman.jsp'" type="submit">新建</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
...
<div style="margin-left:200px;">
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            ...
            <span class="r">共有数据：<strong>${contactscount }</strong> 条</span>
        </div>
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <c:forEach items="${contactslist}" var="z" varStatus="i" >
                    <tr class="text-c va-m">
                        ...
                        <td><span class="price">${z.phone }</span>  </td>
                        <td><span class="price">${z.ramark }</span> </td>


                        <td class="td-manage">


                            <a style="text-decoration:none" class="ml-5" onClick="product_edit('${z.cid}')"   title="编辑">
                                <i class="Hui-iconfont">&#xe6df;</i></a>

                                <a style="text-decoration:none" class="ml-5" onClick="product_del('${z.cid}')"   title="删除">
...
<script type="text/javascript">
    ...
    function product_del(id){
        ...
        if(z){
            $.ajax({
                type: 'POST',
                url:'${pageContext.request.contextPath }/z/zwz_delectlinkman?id='+id,
                dataType: 'json'

            });
            setTimeout(function(){
                self.location='${pageContext.request.contextPath }/zwz/showcontacts.jsp';
            },150);
        }
    ...
    function product_edit(id){
        $.ajax({
            type: 'POST',
            url:'${pageContext.request.contextPath }/z/zwz_updatelinkman?id='+id,
            dataType: 'json'

        });
        setTimeout(function(){
            self.location='${pageContext.request.contextPath }/zwz/updatelinkman.jsp';
        },150);
