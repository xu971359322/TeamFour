...
<body>
	...
	<div id="wrapper">
		...
		<!-- MAIN -->
			...
			<%--<div class="main">--%>
			<%--&lt;%&ndash;<iframe src="zwz/showalluser.jsp" width="100%" height="100%"></iframe>&ndash;%&gt;--%>
			<%--<iframe name='right' src='zwz/showalluser.jsp' frameborder='0' style='width:  1200px;height: 1200px'></iframe>--%>
		    <%--</div>--%>
