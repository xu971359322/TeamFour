...
<body style="background-color:beige;">
	...
	<div id="wrapper">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="${pageContext.request.contextPath}/sevice.jsp" class=""><i class="lnr lnr-cog"></i> <span>服务管理</span></a></li>
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="${pageContext.request.contextPath}/p/ping_showChartGX" target="myfrm" class="">客户贡献分析</a></li>
									<li><a href="${pageContext.request.contextPath}/p/ping_showChartFX" target="myfrm" class="">客户构成分析</a></li>
									<li><a href="${pageContext.request.contextPath}/p/ping_showChartFW" target="myfrm" class="">客户服务分析</a></li>
									<li><a href="${pageContext.request.contextPath}/p/ping_showChartLS" target="myfrm" class="">客户流失分析</a></li>
								</ul>
							</div>
						</li>
		...
		<div class="main">
			<iframe name="myfrm" src="${pageContext.request.contextPath}/pjsp/main.jsp"  style="height:900px;width:100%;"frameborder="no" scrolling="auto"></iframe>
		</div>
