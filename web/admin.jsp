			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="statistice.jsp" class=""><i class="lnr lnr-alarm"></i> <span>统计报表</span></a></li>
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-code"></i> <span>基础数据</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="page-profile.html" class="">数据字典管理</a></li>
									<li><a href="page-login.html" class="">查询产品信息</a></li>
									<li><a href="page-login.html" class="">查询库存</a></li>
								</ul>
							</div>
						</li>
					</ul>
